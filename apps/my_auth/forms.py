...
class LoginForm(forms.Form,FormMixin):
    ...
    password = forms.CharField(max_length=20,min_length=5,error_messages={"max_length":"密码最多不能超过20个字符！","min_length":"密码最少不能少于5个字符！"})
...
class RegisterForm(forms.Form,FormMixin):
    ...
    def clean(self):
        ...
        if password1 != password2:  # 校验两次密码输入是否相同
